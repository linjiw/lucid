...
**September 5, 22:47 EDT update (September 6, 02:47 UTC):** the fresh-history arm is at 116/2,000 iterations, with no monitor warnings; the restored-history arm remains queued after the fresh arm and its evaluations. No new long-run endpoint is available. Independent CPU analysis now [bounds pelvis translation error](lucid-root-feedback-findings-2026-09-05.md) using existing qualified records. It establishes a translation-error increase for the earlier replay/gate panels but leaves the fixed-initial change unresolved. Ten focused tests and formatting/lint checks pass. This specifies a more informative future feedback measurement without changing the active experiment or activating a learned signal.
